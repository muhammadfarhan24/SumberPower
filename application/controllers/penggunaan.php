...
class penggunaan extends CI_Controller {
  ...
  public function index()
    {
        ...
        $data['judul'] = "Pelanggan | Halaman Penggunaan Listrik";
  ...
  public function detail_penggunaan($id)
  {
      ...
      $data['judul'] = "Sumber Power | Halaman Data Detail Penggunaan";
  ...
  public function detail_tagihan($id){
    ...
    $data['DataTarif'] = $this->penggunaan->getDataTarif();
    $data['judul'] = "Sumber Power | Halaman Data Tagihan Pelanggan";
